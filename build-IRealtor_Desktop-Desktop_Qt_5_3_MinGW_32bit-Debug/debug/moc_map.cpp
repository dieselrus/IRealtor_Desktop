...
#include "../../IRealtor_Desktop/map.h"
...
QT_MOC_LITERAL(8, 76, 16)
    ...
    "Map\0reloadMap\0\0replyFinished\0"
    "QNetworkReply*\0loadCoordinates\0geoCode\0"
    "address\0clearCoordinates"
};
...
void Map::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->reloadMap(); break;
        case 1: _t->replyFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 2: _t->loadCoordinates(); break;
        case 3: _t->geoCode((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 4: _t->clearCoordinates(); break;
        default: ;
        }
        ...
        {
            typedef void (Map::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Map::reloadMap)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Map::staticMetaObject = {
    { &QWebView::staticMetaObject, qt_meta_stringdata_Map.data,
